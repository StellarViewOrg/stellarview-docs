...
- **Transactions** — Search by hash, browse recent transactions, view operations and effects
...
Toggle Developer Mode from the header to see additional technical details like raw XDR data, operation parameters, and effect metadata.
